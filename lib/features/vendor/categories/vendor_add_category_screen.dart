...
class VendorAddCategoryScreen extends StatefulWidget {
  ...
  @override
  State<VendorAddCategoryScreen> createState() => _VendorAddCategoryScreenState();
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            TextField(controller: _name, decoration: const InputDecoration(labelText: 'Category name')),
            TextField(controller: _iconName, decoration: const InputDecoration(labelText: 'Icon name')),
            TextField(controller: _categoryIcon, decoration: const InputDecoration(labelText: 'Category icon (URL)')),
